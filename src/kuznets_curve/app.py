...
def main() -> None:
    ...
    if selected == "Explanations":
        ...
        st.write(
            ...
            "\n"
            "At the first stage, inequalities are what create economic growth. The investments are focused on infrastructure capital and natural capital.\n"
            "The investors capture all the wealth created: it increases inequalities.\n"
            "Moreover, according to Kuznets, workers benefit little from growth because the influx of workers from the countryside limits the increase in wages.\n"
            "\n"
            "At the second stage, inequalities are reduced: a shift occurs from secondary sector to tertiary sector.\n"
